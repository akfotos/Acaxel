...
(function () {
  ...
  const PARENT_CHILDREN = [
    { id: 'child-001', name: 'Adaeze Okonkwo',      cls: 'JSS 2A', avatar: 'AO' },
    { id: 'child-002', name: 'Chukwuemeka Okonkwo', cls: 'Primary 5B', avatar: 'CO' },
  ];
  ...
  function seedDemoData() {
    ...
    const today = todayStr();
    const demo = [
      { id:'d1', childId:'c001', childName:'Ama Asante',       cls:'JSS 1A', parent:'Mr. Asante',   date:today, time:'07:42:10', status:'on-time', method:'QR Scan' },
      { id:'d2', childId:'c002', childName:'Kofi Mensah',      cls:'JSS 2B', parent:'Mrs. Mensah',  date:today, time:'07:55:30', status:'on-time', method:'QR Scan' },
      { id:'d3', childId:'c003', childName:'Adaeze Okonkwo',   cls:'JSS 2A', parent:'Mrs. Okonkwo', date:today, time:'08:12:45', status:'late',    method:'Manual Code' },
      { id:'d4', childId:'c004', childName:'Nana Boateng',     cls:'Primary 5B', parent:'Mr. Boateng', date:today, time:'07:38:00', status:'on-time', method:'QR Scan' },
      { id:'d5', childId:'c005', childName:'Emeka Chukwu',     cls:'JSS 3C', parent:'Mr. Chukwu',   date:today, time:'08:25:15', status:'late',    method:'QR Scan' },
    ];
    saveLog(demo);
  }
